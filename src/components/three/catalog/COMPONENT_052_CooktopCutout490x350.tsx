...
export const COMPONENT_052_ID = 'COMPONENT_052';
export const COMPONENT_052_NAME = 'Recorte Cooktop 490x350';

const CUTOUT_WIDTH = 0.49;
const CUTOUT_DEPTH = 0.35;

export function Component052CooktopCutout490x350({
  width,
  depth,
  thickness,
  stoneName,

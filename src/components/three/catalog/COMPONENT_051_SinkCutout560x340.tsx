...
export const COMPONENT_051_ID = 'COMPONENT_051';
export const COMPONENT_051_NAME = 'Recorte Cuba 560x340';

const CUTOUT_WIDTH = 0.56;
const CUTOUT_DEPTH = 0.34;

export function Component051SinkCutout560x340({
  width,
  depth,
  thickness,
  stoneName,
